...
\begin{figure}[t]
    ...
    \caption{Activation distributions for SAE feature~604 (``harmful unethical behavior''). Context activations show a decaying single-headline component and a higher-valued body when both headlines fire; diff activations show a central mass with positive and negative tails. Dashed lines mark the walk thresholds.}
